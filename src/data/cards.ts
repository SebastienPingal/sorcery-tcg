...
export const PRECON_DECKS = [
  ...
  },
  {
    ...
    name: 'Keyword Lab',
    avatarId: 'harbinger',
    description: 'Keyword-heavy deck for engine behavior testing.',
    atlasIds: [
      ...
      ...Array(3).fill('humble_village'),
      ...Array(3).fill('dark_tower'),
    ],
    spellbookIds: [
      ...Array(2).fill('aaj_kegon_ghost_crabs'),
      ...Array(2).fill('ghost_ship'),
      ...Array(2).fill('accursed_albatross'),
      ...Array(2).fill('cave_trolls'),
      ...Array(2).fill('sand_worm'),
      ...Array(2).fill('stygian_archers'),
      ...Array(2).fill('flaming_skull'),
      ...Array(2).fill('nosferatu'),
      ...Array(2).fill('giant_shark'),
      ...Array(2).fill('intrepid_hero'),
      ...Array(2).fill('dame_britomart'),
      ...Array(2).fill('ignited'),
      ...Array(2).fill('frozen_horror'),
      ...Array(2).fill('guardian_angel'),
      ...Array(4).fill('call_of_the_sea'),
      ...Array(4).fill('abyssal_assault'),
      ...Array(4).fill('blink'),
      ...Array(4).fill('baptize'),
      ...Array(4).fill('trial_by_fire'),
      ...Array(4).fill('bind_evil'),
