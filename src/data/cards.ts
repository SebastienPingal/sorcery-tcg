...
export const PRECON_DECKS = [
  ...
  },
  {
    ...
    spellbookIds: [
      ...
      ...Array(4).fill('sewer_rats'),
      ...Array(4).fill('forsaken'),
      ...Array(4).fill('drowned'),
      ...Array(4).fill('sherwood_huntress'),
      ...Array(4).fill('holy_warrior'),
      ...Array(4).fill('ignited'),
      ...Array(4).fill('flaming_skull'),
      ...Array(4).fill('aaj_kegon_ghost_crabs'),
      ...Array(4).fill('accursed_albatross'),
      ...Array(4).fill('cave_trolls'),
